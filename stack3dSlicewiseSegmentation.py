...
import honeycombSurfaceDetector
import helpers
...
class stack3dSlicewiseSegmentation:
    ...
    def segmentVolume(self, layerNum, savePointsPath='', loadPointsPath='', visualize=True):
        ...
        self.hcList = [HoneycombUnfoldSlicewise3d(self.imgStack, self.vis_img, visualize=visualize) for i in range(layerNum)]
...
if __name__ == "__main__":
    ...
    helperDetector = honeycombSurfaceDetector.WallCenterDetector(smoothness=helperDetectionSmoothness)
    # Slicewise segmentation instance
    honeycombSegmentation = stack3dSlicewiseSegmentation(imgStack=I, 
